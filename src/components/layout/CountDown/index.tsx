...
interface CountdownProps {
    ...
    setIsAllowedMint: React.Dispatch<React.SetStateAction<boolean>>
}

const Countdown: React.FC<CountdownProps> = ({ targetDate, isAllowedMint, setIsAllowedMint }) => {
    ...
    useEffect(() => {
        const intervalId = setInterval(() => {
            ...
            if (distance <= 0) {
                ...
                setCountdown(0)
                setIsAllowedMint(true)
                console.log('Mint is allowed')
            } else {
